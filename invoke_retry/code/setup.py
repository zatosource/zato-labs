...
long_description = description = 'Zato 1.1 service providing invoke_retry & invoke_async_methods for retrying invocations, blockingly or in background (https://zato.io/docs/index.html)'

setup(
      name = 'zato-invoke-retry',
      version = version,
